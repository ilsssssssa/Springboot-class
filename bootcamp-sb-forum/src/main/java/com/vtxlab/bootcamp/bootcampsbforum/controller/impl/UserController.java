...
import com.vtxlab.bootcamp.bootcampsbforum.dto.gov.response.request.UserPostRequestDTO;
import com.vtxlab.bootcamp.bootcampsbforum.dto.gov.response.request.UserRequestDTO;
...
public class UserController implements UserOperation {
  ...
  public ApiResponse<UserEntity> save(UserPostRequestDTO userPostRequestDTO) {
    return ApiResponse.<UserEntity>builder() //
        .ok()
        .data(userService.save(userPostRequestDTO)) //
        .build();
  }
